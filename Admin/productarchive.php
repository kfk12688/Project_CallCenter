...
if(isset($_POST['download']))
{
	...
	$list=implode(",", $_POST['delete1']);
		$sql="UPDATE productmaster SET download = 'YES' Where id IN ($list)";
		mysql_query($sql)or die(mysql_error());
		header("location:download/productarchive/demo.php");
}
}
?>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Product Archive</h2>
						<div class="box-icon">
							<a href="productarchive.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						while($query2 = mysql_fetch_object($query1))
						{
							...
							echo'<tr>
								...
								<td class="center">	'.$query2->category.'</td>	
								<td class="center">	'.$query2->series.'</td>																					
							</tr>';
