...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						...
						<div class="box-icon">
							<a href="valuebasedreport.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						<div class="control-group">
							  ...
							  <div class="controls">
							 <input type="text" name="from" placeholder="Rs     /-">&nbsp;&nbsp;&nbsp;&nbsp;To<input type="text" name="to" placeholder="Rs    /-">
						...
						{
							$ref1=$query2->balancedue;	
							echo $ref1;						
							if($from >= $ref1 && $to <= $ref1)
							{
							$ss = $s++;
							echo'<tr>
								<td>'.$ss.'</td>
