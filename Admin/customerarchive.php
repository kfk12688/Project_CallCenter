...
if(isset($_POST['download']))
{
	...
	$list=implode(",", $_POST['delete1']);
		$sql="UPDATE customermaster SET download = 'YES' Where id IN ($list)";
		mysql_query($sql)or die(mysql_error());
		header("location:download/customerarchive/demo.php");
}
}
?>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Customer Archive</h2>
						<div class="box-icon">
							<a href="customerarchive.php" ><i class="halflings-icon refresh"></i></a>
