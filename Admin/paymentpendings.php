...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Payment Pendings</h2>
						<div class="box-icon">
							<a href="paymentpendings.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						<?php
						$s=1;												
						$query1 = mysql_query("SELECT * FROM reports where amountbalance > 0")or die(mysql_error());
