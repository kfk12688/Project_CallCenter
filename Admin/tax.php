			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="#"><i class="icon-tasks"></i><span class="hidden-tablet"> Assign User View</span></a></li>						
						<li>
						...
						<li><a href="#"><i class="icon-font"></i><span class="hidden-tablet"> Archive Data</span></a></li>
...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Date Based Reports</h2>
						<div class="box-icon">
