	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Select The Table To Archive</h2>
						<div class="box-icon">
							<a href="archivedata.php" ><i class="halflings-icon refresh"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="checktable.php">
						  <fieldset>
						  	 <div class="control-group">
								<label class="control-label">Select Table</label>
								<div class="controls">								  
									<select name="archivedata">
									<option>Customer Master</option>
									<option>Engineer Master</option>
									<option>Product Master</option>
									<option>Spare Master</option>
							...
							<div class="form-actions">
							  <button type="submit" title="Select Table Before Archive Data"data-rel="tooltip" class="btn btn-primary">Archive</button>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Restore Archive</h2>
						<div class="box-icon">
							<a href="archivedata.php" ><i class="halflings-icon refresh"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="uploadarchive.php">
						  <fieldset>
						  	<div class="control-group">
								<label class="control-label">Select Table</label>
								<div class="controls">								  
									<select name="restorearchive">
									<option>Customer Master</option>
									<option>Engineer Master</option>
									<option>Product Master</option>
									<option>Spare Master</option>
							...
							<div class="control-group">
							  <label class="control-label" for="fileInput">Select File To Import</label>
							  <div class="controls">
								<input class="input-file uniform_on" id="fileInput" type='file' name='filename'>
							  </div>
							</div>							
							<div class="form-actions">
							  <button type="submit" title="Select Table Before Restore Archive"data-rel="tooltip" class="btn btn-primary">Restore Archive</button>
							  &nbsp;<input type="reset" class="btn" value="Cancel">
