...
if(isset($_POST['download']))
{
	...
	$list=implode(",", $_POST['delete1']);
		...
		header("location:download/requestarchive/demo.php");
}
}
?>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Request Archive</h2>
						<div class="box-icon">
							<a href="requestarchive.php" ><i class="halflings-icon refresh"></i></a>
