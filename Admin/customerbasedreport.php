	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="#">Customer Based Report</a>
				</li>
			</ul>		
...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Customer Based Reports</h2>
						<div class="box-icon">
							<a href="customerbasedreport.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						<div class="control-group">
							  <label class="control-label">Customer ID / Name</label>
							  <div class="controls">
							  <select name="customerid">
							  <option></option>
							  <?php
							  $query34=mysql_query("SELECT * From customermaster")or die(mysql_error());
							  while($query35 = mysql_fetch_object($query34))
							  {
							  	echo'<option>'.$query35->customerid.'</option>';
							  }
							  ?>
							  </select>&nbsp;&nbsp;&nbsp;&nbsp;
								 ...
								 <option></option>
							  <?php
							  $query36=mysql_query("SELECT * From customermaster")or die(mysql_error());
							  while($query37 = mysql_fetch_object($query36))
							  {
							  	echo'<option>'.$query37->customername.'</option>';
							  }
							  ?>
							  </select>&nbsp;&nbsp;&nbsp;&nbsp;
						...
						$query1 = mysql_query("SELECT * FROM newrequest where customername='$customername' OR customerid='$customerid'")or die(mysql_error());
