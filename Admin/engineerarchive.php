...
if(isset($_POST['download']))
{
	...
	$list=implode(",", $_POST['delete1']);
		$sql="UPDATE engineermaster SET download = 'YES' Where id IN ($list)";
		mysql_query($sql)or die(mysql_error());
		header("location:download/engineerarchive/demo.php");
}
}
?>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Engineer Archive</h2>
						<div class="box-icon">
							<a href="engineerarchive.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						while($query2 = mysql_fetch_object($query1))
						{
							...
							echo'<tr>
								...
								<td class="center">	'.$query2->position.'</td>	
								<td class="center">	'.$query2->contactnumber.'</td>
								<td class="center">	'.$query2->emailid.'</td>													
							</tr>';
						...
						?>
							...
							<a href="archivedata.php" class="btn btn-info">Back</a>							
							<input type="submit"  title="Click Checkboxs To Archive Data's." data-rel="tooltip" name="download" class="btn btn-primary" value="Archive">&nbsp;&nbsp;
