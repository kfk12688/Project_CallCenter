...
if(isset($_POST['submit']))
{
	if(isset($_POST['delete']))
	{
		...
		$sql="DELETE from productmaster Where id IN ($list)";
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Upload Product Master</h2>
						<div class="box-icon">
							<a href="productmaster.php" ><i class="halflings-icon refresh"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form class="form-horizontal" enctype='multipart/form-data' method="POST" action="productupload.php">
						  <fieldset>
					...
					<div class="box-content">
						...
						while($query2 = mysql_fetch_object($query1))
						{
							...
							<td class="center"><input type="hidden" name="id[]" value="'.$query2->id.'">
								...
								<td class="center">'.$query2->productid.'</a></td>
						...
						?>
							...
							<div class="form-actions" >
							 <a class="btn btn-primary" href="productmaster/demo.php">Download</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
