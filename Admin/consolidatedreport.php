...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Consolidated Reports</h2>
						<div class="box-icon">
							<a href="consolidatedreport.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						while($query2 = mysql_fetch_object($query1))
						{
							...
							echo'<tr>
								...
								<td class="center">'.$query2->mechanicalissues.'</td>
								<td class="center">'.$query2->electricalissues.'</td>
								<td class="center">'.$query2->otherissues.'</td>	
								<td class="center">'.$query2->calibrationcertificate.'</td>
