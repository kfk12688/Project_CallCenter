...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Cash Payments</h2>
						<div class="box-icon">
							<a href="cashpayments.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						<?php
						$s=1;												
						$query1 = mysql_query("SELECT * FROM payments where paymentmethod='Cash'")or die(mysql_error());
						while($query2 = mysql_fetch_object($query1))
						{
							...
							echo'<tr>
								...
								<td class="center">'.$query2->particulars.'</td>																					
							</tr>';												 
							}						
						?>
						 </tbody>
