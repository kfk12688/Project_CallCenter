...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Net Banking</h2>
						<div class="box-icon">
							<a href="netbankings.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						<?php
						$s=1;												
						$query1 = mysql_query("SELECT * FROM payments where paymentmethod='Netbanking'")or die(mysql_error());
						while($query2 = mysql_fetch_object($query1))
						{
							...
							echo'<tr>
								...
								<td class="center">'.$query2->bankname.'</a></td>
								<td class="center">'.$query2->referenceno.'</td>
