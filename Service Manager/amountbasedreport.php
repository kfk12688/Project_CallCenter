...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Amount Based Reports</h2>
						<div class="box-icon">
							<a href="amountbasedreport.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						while($query2 = mysql_fetch_object($query1))
						{
							...
							echo'<tr>
								...
								<td class="center">'.$query2->paymentstatus.'</td>								
								<td class="center">'.$query2->paymentmethod.'</td>
								<td class="center">'.$query2->paymentoption.'</td>
								<td class="center">'.$query2->totalamount.'</td>		
								<td class="center">'.$query2->amountreceived.'</td>									
								<td class="center">'.$amountbalance.'</td>														
							</tr>';						
						}		
						?>
						 </tbody>
