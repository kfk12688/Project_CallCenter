...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						...
						<div class="box-icon">
							<a href="datebasedreport.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						$query1 = mysql_query("SELECT * FROM newrequest where dated BETWEEN '$from' and '$to'")or die(mysql_error());
						while($query2 = mysql_fetch_object($query1))
						{
							...
							echo'<tr>
								...
								<td class="center">'.$query2->status.'</td>														
							</tr>';
