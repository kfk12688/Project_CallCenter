...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Product Based Reports</h2>
						<div class="box-icon">
							<a href="productbasedreport.php" ><i class="halflings-icon refresh"></i></a>
					...
					<div class="box-content">
						...
						<div class="control-group">
							  ...
							  <option></option>
							  <?php
							  $query34=mysql_query("SELECT * From productmaster")or die(mysql_error());
							  while($query35 = mysql_fetch_object($query34))
							  {
							  	echo'<option>'.$query35->productid.'</option>';
							  }
							  ?>
							  </select>&nbsp;&nbsp;&nbsp;&nbsp;
								 ...
								 <option></option>
							  <?php
							  $query36=mysql_query("SELECT * From productmaster")or die(mysql_error());
							  while($query37 = mysql_fetch_object($query36))
							  {
							  	echo'<option>'.$query37->productname.'</option>';
							  }
							  ?>
							  </select>&nbsp;&nbsp;&nbsp;&nbsp;
						...
						$query1 = mysql_query("SELECT * FROM newrequest where productname='$productname' OR productid='$productid'")or die(mysql_error());
