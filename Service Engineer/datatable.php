...
<link rel="stylesheet" type="text/css" href="datatable/css/jquery.dataTables.css">
		...
		<script type="text/javascript" language="javascript" src="datatable/js/dataTables.tableTools.js"></script>
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
			   var dataTable =  $('#employee-grid').DataTable( {
			   	...
			   	processing: true,
			   	serverSide: true,
		   		ajax: "datatable/employee-grid-data.php", // json datasource
			    } );
			} );
		</script>
		<style>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"><span><?php echo'<img src="'.$location.'" alt="vbs" class="img-rounded" width="30">';?>&nbsp;&nbsp;<?php echo $companyname; ?></span></a>
